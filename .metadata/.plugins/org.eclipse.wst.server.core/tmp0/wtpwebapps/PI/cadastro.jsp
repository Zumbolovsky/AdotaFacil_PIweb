	...
	<div id="conteudo" style="margin: 50px;">
		<form name="cadastrarUsuario" action="usuarios" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input class="form-control" type="password" id="pass1" required="required"
						placeholder="Senha" name="pass1" maxlength="20" min="3"> <small
						id="passwordHelpBlock" class="form-text text-muted"> Sua
						senha deve conter de 3 a 20 caracteres. </small>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="cpf" required="required"
						...
						id="passwordHelpBlock" class="form-text text-muted"> Insira
						 11 dígitos para o CPF ou 18 para o CNPJ. </small>
				</div>
			</div>
			<div class="form-group row">
