...
<body>
	...
	<div id="conteudo" style="margin: 50px;">
		<form name="contato" action="contatos" method="post">
			<div class="form-group row">
				<h3>Entre em contato conosco</h3>
			</div>
			<div class="form-group row">
				<h5 style="color: grey;">Os campos com (*) são obrigatórios</h5>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="mensagem" name="mensagem"
						...
						id="passwordHelpBlock" class="form-text text-muted"> Máximo de 200 caracteres. </small>
				</div>
			</div>
			<div class="form-group row">
