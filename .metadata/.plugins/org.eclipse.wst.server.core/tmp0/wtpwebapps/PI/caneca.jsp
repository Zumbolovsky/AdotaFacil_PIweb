	...
	<div id="conteudo" style="margin: 50px;">
		...
		<div class="row" style="min-height: 200px">
			<div class="col-sm-5" style="padding-bottom: 30px">
				<img id="imagem" src="imagens/caneca.jpg" alt="Caneca" style="width: inherit; height: inherit;">
			</div>

			<div class="col-sm-6" id="descricao">
				<h3 class="col-sm-12">Caneca</h3>
				<p class="col-sm-12">Caneca Adota Fácil</p>
				<hr style="min-height: 2px"/>
				
				<label class="col-sm-12">Preço:</label>
				<h4 class="col-sm-12" style="height: 25%;">R$ 49,00</h4>
			</div>
		</div>
