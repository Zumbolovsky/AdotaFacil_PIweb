...
<html>
    ...
    <body>
        ...
        <div id="conteudo" style="margin: 50px;">
            ...
            <div class="row" style="margin-top: 25px;">    
                <p>Para informações sobre como ajudar na adoção de crianças e jovens
                    orfãos, <a href="cadastrarUsuario.jsp">faça parte</a> de nossa causa!
                    É um simples cadastro para que possamos melhor comunicar a todos as
                    informações concernentes a processos adotivos e os mais diversos 
                    eventos.</p>
            </div>
            <div class="row" style="margin-top: 25px;">
                <h5>Merch</h5>
            ...
            <div class="row" style="margin-top: 25px;">
                <p>Caso deseje ajudar nossa causa, porém não queira criar um cadastro,
                    possuimos uma área para <a href="doacao.jsp">doações</a> que podem ser
