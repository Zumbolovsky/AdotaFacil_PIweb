        ...
        <div id="conteudo" style="margin: 50px;">
            ...
            <div class="row" style="min-height: 160px">
                <div class="col-sm-5" style="margin-top: 30px">
                    <img id="imagem" src="/PI/imagens/caneta.jpg" alt="Caneta" style="width: inherit; height: inherit;">
                </div>

                <div class="col-sm-6" id="descricao">
                    <h3 class="col-sm-12">Caneta</h3>
                    <p class="col-sm-12">Caneta Adota Fácil</p>
                    <hr style="min-height: 2px;"/>

                    <label class="col-sm-12">Preço:</label>
                    <h4 class="col-sm-12" style="min-height: 20px;">R$ 10,00</h4>
                </div>
            </div>
            <form action="carrinho" method="post">
                <input name="produto" value="Caneta" id="Caneta" type="hidden">
                <div class="row">
