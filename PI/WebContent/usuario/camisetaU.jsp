        ...
        <div id="conteudo" style="margin: 50px;">
            ...
            <div class="row" style="min-height: 160px">
                <div class="col-sm-5" style="margin-top: 30px">
                    <img id="imagem" src="/PI/imagens/camiseta.jpg" alt="Camiseta" style="width: inherit; height: inherit;">
                </div>

                <div class="col-sm-6" id="descricao">
                    <h3 class="col-sm-12">Camiseta</h3>
                    <p class="col-sm-12">Camiseta Adota Fácil</p>
                    <hr style="min-height: 2px"/>

                    <label class="col-sm-12">Preço:</label>
                    <h4 class="col-sm-12" style="min-height: 20px;">R$ 49,99</h4>
                </div>
            </div>
